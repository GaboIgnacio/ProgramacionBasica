...
def menu():
    while True:  # Menú activo en bucle hasta que el usuario escriba 'terminar'
        print("\n--- ¡Es hora de ponerte a trabajar! Elige una opción para empezar. 🤡 ---")
        print("----------------------------------------------------------------------\n")
        # Mostramos las opciones disponibles (sin número para salir)
        print("           1. Agregar dato nuevo")
        print("           2. Eliminar dato por ID")
        print("           3. Agregar dato en posición específica")
        print("           4. Ver datos almacenados")
        print("\nPara salir del programa escribe 'terminar' cuando se te pida una opción.")
        print("\n")
        ...
        if opcion == "1":
            ...
            # Mensaje de despedida con buena onda
            print("\n👋 ¡Hasta luego, rey 👑, fiera 🐯, campeón 🏆, crack ⚡, máquina 🔧, leyenda 📜, monstruo 👹, titán 🗿, genio 🧠, sensei 🥋!")
            break  # Rompemos el bucle para terminar el programa
        else:
            # Mensaje si escriben algo incorrecto
